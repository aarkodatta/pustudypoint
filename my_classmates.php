        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
					...
					$id = isset ($row["teacher_class_student_id"]);	
					?>
					     <ul class="breadcrumb">
							<li><a href="#"><?php echo isset ($row["class_name"]); ?></a> <span class="divider">/</span></li>
							<li><a href="#"><?php echo isset ($row["subject_code"]); ?></a> <span class="divider">/</span></li>
							<li><a href="#">School Year: <?php echo isset ($row["school_year"]); ?></a> <span class="divider">/</span></li>
