<div class="navbar navbar-fixed-top navbar-inverse">
        <div class="navbar-inner">
            <div class="container-fluid">
                ...
                <a class="brand" href="#">Welcome to: Study Point (PU) </a>
					<div class="nav-collapse collapse">
						<ul class="nav pull-right">
							...
							?>
							<li class="dropdown">
								<a href="#" role="button" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-user icon-large"></i><?php echo isset ($row['firstname'])." ".isset ($row['lastname']);  ?> <i class="caret"></i></a>
